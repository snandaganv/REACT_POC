...
const SelectsDefaultTemplate = (args) => (<SelectsDefault {...args}></SelectsDefault>);
...
const SelectsVariantTemplate = (args) => (<SelectsVariant {...args}></SelectsVariant>);
...
const SelectsAutoWidthTemplate = (args) => (<SelectsAutoWidth {...args}></SelectsAutoWidth>);
...
const SelectsOtherPropsTemplate = (args) => (<SelectsOtherProps {...args}></SelectsOtherProps>);
...
const SelectsMultipleTemplate = (args) => (<SelectsMultiple {...args}></SelectsMultiple>);
...
const SelectsMultipleCheckmarkTemplate = (args) => (<SelectsMultipleCheckmark {...args}></SelectsMultipleCheckmark>);
...
const SelectsMultipleChipTemplate = (args) => (<SelectsMultipleChip {...args}></SelectsMultipleChip>);
...
const SelectsMultiplePlaceholderTemplate = (args) => (<SelectsMultiplePlaceholder {...args}></SelectsMultiplePlaceholder>);
