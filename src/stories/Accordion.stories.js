...
const AccordionControlledTemplate = (args) => (
  <AccordionControlled {...args}></AccordionControlled>
);
...
const AccordionCustomizationTemplate = (args) => (
  <AccordionCustomization {...args}></AccordionCustomization>
);
