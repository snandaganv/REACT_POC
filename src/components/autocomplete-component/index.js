...
const AutocompleteComponent = (props) => {
  const {options,autoComplete,autoHighlight,autoSelect,clearOnBlur,clearText,closeText,disableClearable,
    id,inputValue,disableCloseOnSelect,disabled,fullWidth,multiple,loading,readOnly,label,clearOnEscape} = props;
