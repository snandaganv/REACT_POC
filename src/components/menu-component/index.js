...
export const MenusDense = ({ dense, densetext, densetext1, denseicon, autoFocus, disableGutters, divider }) => {
    return (
        <Paper sx={{ width: 320 }}>
...
export const MenusIcon = ({ menuicons, menuclip }) => {
    return (
