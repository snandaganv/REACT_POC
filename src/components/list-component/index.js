      ...
      {basicLists.map((basicList) =>    
        <List>           
          <ListItem disablePadding={disablePadding} key={basicList.id}>
            <ListItemButton>
            <ListItemIcon><Icon>{basicList.icon}</Icon></ListItemIcon>
      ...
      return (
        ...
        <List component="div" disablePadding={disablePadding}>
          <ListItemButton sx={{ pl: 4 }}>
            <ListItemIcon><Icon>{nestedList.icon1}</Icon></ListItemIcon>
  ...
  return (
    ...
    <List sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper' }}>
      ...
      <ListItem key={folderList.id}>
        <ListItemAvatar><Avatar><Icon>{folderList.icon}</Icon></Avatar></ListItemAvatar>
          ...
          <Demo>
            <List dense={dense}>
              { interactiveLists.map((interactiveList)=>
                <ListItem>
                  <ListItemIcon>
                    <Icon>{interactiveList.icon}</Icon>
                  </ListItemIcon>
                  <ListItemText
                    primary={interactiveList.primary}
                    secondary={secondary ? interactiveList.secondary : null}
        ...
        <Grid item xs={12} md={6}>
          ...
          <Demo>
            ...
            { interactiveLists.map((interactiveList)=>
                <ListItem>
                  <ListItemAvatar>
                    <Avatar><Icon>{interactiveList.icon}</Icon>
                    </Avatar>
                  </ListItemAvatar>
                  <ListItemText
                    primary={interactiveList.primary}
                ...
                <ListItem
                  secondaryAction={
                    <IconButton edge={edge} aria-label="delete">
                      <Icon>{interactiveList.icon1}</Icon>
                    </IconButton>
                  }
                >
                  <ListItemAvatar>
    ...
    <Box sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper' }}>
      ...
      <List component="nav" aria-label="main mailbox folders">
        <ListItemButton selected={selectedIndex === selectedListItem.id}
          ...
          <ListItemIcon><Icon>{selectedListItem.icon}</Icon></ListItemIcon>
