...
PaginationDefaults.defaultProps = {
  count: 10,
  size: "medium",
  color: "standard",
  shape: "circular",
...
PaginationsControlled.prototype = {
  count: PropTypes.number,
  size: PropTypes.oneOf(["small", "medium", "large"]),
  color: PropTypes.oneOf(["primary", "secondary", "standard"]),
  shape: PropTypes.oneOf(["circular", "rounded"]),
...
PaginationsControlled.defaultProps = {
  count: 10,
  size: "medium",
  color: "standard",
  shape: "circular",
